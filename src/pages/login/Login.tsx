    ...
    <div className="h-screen flex flex-col lg:flex-row w-full">
      <div className="lg:w-1/2 py-20 flex flex-col space-y-3 justify-center items-center">
        <div className="flex flex-col justify-center w-[330px] text-center gap-5">
          ...
          <p className="font-light text-sm md:text-md lg:text-lg mb-4">
            Login on the Below
          </p>
            ...
            <div className="flex flex-col gap-4">
              <div className="grid gap-2 md:grid md:grid-cols-12">
                <div className="flex space-x-2 justify-between col-span-12">
                  <label htmlFor="email" className="block text-gray text-sm">
                    Email
                  </label>
                </div>
              ...
              <div className="grid gap-2 md:grid md:grid-cols-12">
                <div className="flex space-x-2 justify-between col-span-12">
                  <label htmlFor="password" className="block text-gray text-sm">
                    Password
                  </label>
                </div>
                <div className="col-span-12">
              ...
              <button
                form="signIn-form"
                className="relative bg-blue-500 text-white py-2 rounded-md hover:bg-blue-700 transition ease-in outline-none"
              >
                Sign In
              </button>
            </div>
      ...
      <div className="bg-blue-700 lg:w-1/2 py-20 flex flex-col text-center items-center mx justify-center space-y-8 h-full">
        ...
        <p className="text-white max-w-xs text-md md:text-lg font-light">
          Enter your personal details and start journey with us
        </p>
        <NavLink
          to="/signup"
          className="border-2 hover:bg-white hover:text-blue-700 transition ease-in border-white text-white px-10 py-2 rounded-md"
        >
          SIGN UP
        </NavLink>
      </div>
