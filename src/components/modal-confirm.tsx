...
export const ModalConfirm = ({
  ...
  return (
    <div
      data-modal="confirm"
      className="fixed inset-0 bg-black bg-opacity-60 transition-opacity duration-300 ease-in-out overflow-y-auto h-full flex justify-center items-center"
    >
      <div className="bg-white w-[500px] rounded-lg mx-5 sm:mx-0">
        ...
        <div className="grid grid-cols-12 px-5 mb-4 gap-3">
          <button
            onClick={onClose}
            className="col-span-6 border py-2 rounded-2xl"
          >
            No
          </button>
          <button
            onClick={deleteFunction}
            className="col-span-6 border py-2 rounded-2xl bg-blue-500 text-white"
          >
            Yes
          </button>
        </div>
